...
<div class="main">
    ...
    <h3 class="no_print text-primary text-center" style="margin-top: 0px"><a role="button" href="../../index.php"
                    ...
                    class="fa fa-undo"></i> << Dashboard</a> &nbsp;&nbsp;&nbsp;&nbsp; Supplier Invoice  &nbsp;&nbsp;&nbsp;<button
                class="no_print btn btn-success" onclick="print()">Print
        </button>
    </h3>

    <?php include_once '../../model/p_transection.php';
    $num = new p_transection();
    $number = $num->invoice_no() + 1;
    ?>

    <p style="display: inline">Purchase Invoice NO : <input id="invoice_no" value="<?php echo($number) ?>" disabled
                           style="border: none;background-color: transparent"></p>



    <p class="right date">Date : <input class="form-control" id="date" type="date" value="<?php echo date('Y-m-d'); ?>">
    </p>

    <p  class=" cus_date"> Cus:In:Date : <input
                class="form-control" id="cus_in_date"
                type="date"></p>

    <p>Customer Name : <input class="form-control inline" list="browsers" name="browser" style="display:inline;"
    ...
    <div class="inline">
        ...
        <p class="del_in_no print_del_in_no" style="">Cus:IN:No : <input style="width: 200px;display: inline"
                                                                         class="form-control" id="delivary_invoice_no"
                                                                         type="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </p>
    ...
    <div style="border: 1px black solid;" class="hight higt">
        <table style="width:100%; " id="tbl" class="table table-hover table-striped">
            <thead>
            <tr>
    ...
    <div style="margin-top: 40px" class="no_screen">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="delete_tmp();rowss();sum()">
                    Delete
                </button>
            </div>
...
<script>
    function total_tran() {
        ...
        var payment = document.getElementById("payment").value;
        var delivary_invoice_no = document.getElementById("delivary_invoice_no").value;
        var cus_in_date = document.getElementById("cus_in_date").value;
