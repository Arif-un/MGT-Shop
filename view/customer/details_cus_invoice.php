<?php
include_once "../../model/details_cus_in.php";
$obj =new details_cus_in();
...
include_once "../../model/cus_total_tran.php";
$object=new cus_total_tran();
$all = $object->allCusInfo($_GET['in_no']);
$allinfo= $all[0];
?>
...
<div class="main">
    ...
    <h3 class="no_print text-primary text-center" style="margin-top: 0px"> <a role="button" href="../../index.php" class="btn btn-primary no_print" style="margin-left: 10px"><i
                    class="fa fa-undo"></i> << Dashboard</a> &nbsp;&nbsp;&nbsp;&nbsp; Customer Invoice (old) &nbsp;&nbsp;&nbsp;<button class="no_print btn btn-success" onclick="print()">Print</button></h3>

    <p>Invoice NO : <input id="invoice_no" value="<?php echo $_GET['in_no'] ?>" disabled
                           style="border: none;background-color: transparent"></p>


    <p class="right date" style="margin-top: -40px">Date : <input class="form-control" id="date" type="date" value="<?php echo $allinfo['date'] ?>"
                                                             readonly>
    </p>
    <p>Customer Name : <input list="browsers" value="<?php echo $allinfo['cus_name'] ?>" name="browser"
                              style="" id="cus_name" onchange="trn_no()" readonly>
    </p>
    <p class="right">TRN NO : <input type="text" class="trn"
                                     id="trn" value="<?php echo $allinfo['trn'] ?>" disabled></p>
    <div class="inline">
        <p class="" style="margin-top: -40px">Payment Type : <select id="payment"
                                                                     value="<?php echo $allinfo['payment'] ?>">
                <option value="CASH">CASH</option>
                <option value="CREDIT">CREDIT</option>
            </select></p>
        <p class="del_in_no print_del_in_no" style="">Del:IN:No : <input id="delivary_invoice_no" type="text"
                                                                         value="<?php echo $allinfo['delivary_invoice_no'] ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </p>
    </div>
    ...
    <div style="border: 1px black solid;" class="hight higt">
        <table style="width:100%; " id="tbl" class="table table-hover ">
            ...
            $all = $objct->transactions($allinfo['date'], $allinfo['cus_name'], $_GET['in_no']);
            $serial = 1;
            foreach ($all as $item) { ?>
                <tr>
                    ...
                    <td style="text-align: center;" class="no_print">
                        <button style="color: #dc3545; width: 30px;color: #007bff" class='button fa' onclick='getForEdit(this); ' data-toggle="modal"
    ...
    <div class="clearfix ">
        ...
        <table class="total_table f_right table_top_margin table table-hover table-bordered">
            ...
            <tr>
                ...
                <td class="space"><input id="discount" value="<?php echo $discount ?>" style="border: none;text-align: center"
                                         onkeyup="discount();"></td>
            </tr>
            <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-danger">
                ...
                <input id="quan" name="pd_code" type="text" class="form-control"
                       aria-describedby="inputGroup-sizing-default"  value="" required><div class="input-group-prepend">
...
<script>
    function tran() {
        ...
        $.ajax({
                type: "POST",
                url: "../../controller/details_cus_in_ctrl.php",
                data: final,
...
<script>
    function upadte() {
        ...
        var post_key = {"updateInvoice": inv,
        "payment": pay,
        "del_in" : del_in,
        "dis": dis };
        $.ajax({
