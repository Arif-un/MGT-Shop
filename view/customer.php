...
<h3 class="text-muted text-center" style="margin-top:20px">Add a New Customer</h3>
<a role="button" href="../index.php" class="btn btn-primary" style="float: right;margin: 20px"><i
            class="fa fa-undo"></i> Dashboard</a>

<hr>
<form action="../controller/customer_ctrl.php" method="post">
    ...
    <div class="row justify-content-md-center" style="margin-top:70px ">
        ...
        <div class="input-group mb-3 col col-md-auto">
            ...
            <input name="name" type="text" class="form-control" aria-describedby="inputGroup-sizing-default"
                   style="width: 500px" placeholder="Name" required>
        </div>
        <div class="input-group mb-3 col col-md-auto">
            <div class="input-group-prepend">
                <span class="input-group-text">TRN No</span>
            </div>
            <input name="trn" type="text" class="form-control" aria-describedby="inputGroup-sizing-default"
    ...
    <div class="row justify-content-md-center" style="margin-top:10px ">
        <div class="input-group mb-3 col col-md-auto">
            ...
            <input name="c_person" type="text" class="form-control" aria-describedby="inputGroup-sizing-default"
                   required>
        </div>
        <div class="input-group mb-3 col col-md-auto">
            <div class="input-group-prepend">
...
<div class="" style="margin: 15px">
    <table id="example"
           class="display table table-hover table-active table-responsive-lg table-responsive-md table-responsive-sm"
        ...
        $obj = new customer();
        $all_data = $obj->allActivAndInactive();
        $sl = 0;
...
<div class="modal fade" id="myModalEdit" style="width: auto">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <form action="../controller/customer_ctrl.php" method="post" style="margin: 15px">
...
<script>
    function up_set(element) {
        ...
        document.getElementsByName("u_status")[0].value = table.rows[rowNUm].cells[8].innerHTML;
